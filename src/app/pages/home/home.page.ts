...
export class HomePage implements OnInit {
  pageTitle="Home"
  paragraphs=[
    "Summarise is an app that helps you to manage your Time, Money, and work which includes but not limitted to subject wise studies, notes, to-do's or office works.",
